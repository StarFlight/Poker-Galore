...
package com.cubeia.firebase.io.protocol {
    ...
    public class TournamentSnapshotPacket implements ProtocolObject {
        public static const CLASSID:int = 148;

        public function classId():int {
            return TournamentSnapshotPacket.CLASSID;
        }
        ...
        {
            var result:String = "TournamentSnapshotPacket :";
            result += " mttid["+mttid+"]" ;
